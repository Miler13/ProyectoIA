...
while True:
    ...
    if opcionMenu == "1":
        ...
        materiaE1 = Materia("Fisica", 15, 1, "Ingenieria Informatica")
        #
        ...
        #
        materiaC8 = Materia("Electiva Inteligenci Artificial", 0, 8, "Interacion Humano computador")
        # Demas materias del semestre 4 semestre
        ...
        # elemento raiz
        raiz = Materia("Ingenieria Informatica", 20, 0)
        # Desarrolo de software
        materiaA1 = Materia("Introduccion a la programacion", 14, 1, "Ingenieria Informatica")
        # Demas materias del semestre 1 semestre
        materiaB1 = Materia("Algebra I", 15, 1, "Ingenieria Informatica")
        materiaC1 = Materia("Calculo I", 15, 1, "Ingenieria Informatica")
        materiaD1 = Materia("Ingles I", 15, 1, "Ingenieria Informatica")
        materiaE1 = Materia("Fisica", 15, 1, "Ingenieria Informatica")
        #

        materiaA2 = Materia("Elementos de programacion y Estructura de datos", 13, 2, "Introduccion a la programacion")
        materiaB2 = Materia("Programacion", 12, 2, "Introduccion a la programacion")
        # Demas materias del semestre 2 semestre
        materiaC2 = Materia("Algebra II", 16, 2, "Algebra I")
        materiaD2 = Materia("Calculo II", 16, 2, "Calculo I")
        materiaE2 = Materia("Ingles II", 16, 2, "Ingles I")
        materiaF2 = Materia("Arquitectura por computadoras I", 16, 2, "Fisica")
        #

        materiaA3 = Materia("Metodos y tecnicas de programacion", 11, 3,
                            "Elementos de programacion y Estructura de datos")
        materiaB3 = Materia("Teoria de grafos", 10, 3, "Programacion")
        # Demas materias del semestre 3 semestre
        materiaC3 = Materia("Logica", 17, 3, "Algebra II")
        materiaD3 = Materia("Calculo Numerico", 17, 3, "Calculo II")
        materiaE3 = Materia("Organizacion y metodos", 17, 3, "Ingles II")
        materiaF3 = Materia("Arquitectura por computadoras II", 17, 3, "Arquitectura por computadoras I")
        #

        materiaA4 = Materia("Sistemas de Informacion I", 9, 4, "Metodos y tecnicas de programacion")
        materiaB4 = Materia("Algoritmos Avanzados", 8, 4, "Teoria de grafos")
        # Demas materias del semestre 4 semestre
        materiaC4 = Materia("Programacion Funcional", 18, 4, "Logica")
        materiaD4 = Materia("Probabilidad y estadistica", 18, 4, "Calculo Numerico")
        materiaE4 = Materia("Taller de programacion de bajo nivel", 18, 4, "Arquitectura por computadoras II")
        ...
        # Demas materias del semestre 4 semestre
        materiaC8 = Materia("Electiva Inteligenci Artificial", 21, 8, "Interacion Humano computador")
        materiaD8 = Materia("Electiva de redes", 21, 8, "Tecnologia y redes avanzadas")
        materiaE8 = Materia("Electiva Teoria de computacion II", 21, 8, "Electiva Teoria de computacion")
        materiaF8 = Materia("Electiva base de Datos II", 21, 8, "Electiva base de Datos")
        #
